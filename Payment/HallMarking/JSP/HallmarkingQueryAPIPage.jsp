...
// 							 }
						 ...
						 /* 	theData +="<a target='_blank' href='/MANAK/viewPreviousFeeReceipt?docName=FeeReceipt_"+tid+".pdf'>"+response[i].receipt_no+"</a>"; */
							 ...
							 theData += "<td><input type='button' id='query' class='btn btn-primary' value='Query' onclick='query("+response[i].transactionNumber+")'/>";
							 }else{
								 theData += "<td><input type='button' id='query' class='btn btn-primary' value='Query' onclick='querycorp("+response[i].transactionNumber+")'/>";
							 }
							 theData +="</td>";
