...
<script>
  ...
  <div class="container">
 		...
 		<c:out value="LOT Inspection Fee & Contact BIS "></c:out>
 		</div>
 		<form:form cssClass="form-horizontal" method="post" id="frm" name="frm" action="PayInitiateFeeLOTApplicantSubmit" commandName="model">
 		...
 		<form:hidden path="numTotal" id="numTotal" name="numTotal"/>
 			...
 			<form:hidden path="surv_id" id="surv_id" name="surv_id"/>
 		<fieldset>
