...
<div class="container-fluid">
	<div class="h3 bold text-center">
		<spring:message code="label.GEMReportTitle"></spring:message>
	</div>
	<!-- Main row -->
	<div class="row" id="form-box">
		<form cssClass="form-horizontal" action="<%=applicationPath%>/pc/GEMReport" method="post" class="form-horizontal" id="form1" name="frmSelect" role="form">
                     ...
                     <div class="col-md-6">
                          ...
                          <div class="text-left col-md-2">
                            <!--   <label>Show -->
                               ...
                               <span class="col-md-2">
                               <a href="<%=applicationPath%>/pc/exportGEMReport?type=xls" target="_blank" id="btnDnAll" class="btn btn-info btn-sm" title=" Download all data ">
