...
public class PrimaryDaoHelperFMCS {

	@Autowired
	@PersistenceContext(unitName="unitfmcs")
	@Qualifier(value="myEmfFMCS")
	private EntityManager entityManager;

	public PrimaryDaoHelperFMCS() {
	}

	public PrimaryDaoHelperFMCS(final EntityManager entityManager) {
	...
	public List<Object[]> nativeQuerywithMultipleObjects(String query)
	{
