...
import eBIS.Utility.Service.LIMPSTestReportDownloadService;

@Controller
public class LIMPSTestReportDownloadController {
	@Autowired
	LIMPSTestReportDownloadService service;
	@Autowired 
	FtpConfiguration ftpConfiguration;
	@RequestMapping(value = "/downloadTestReportLIMPS/{qrcode}/{checksum}/{extension}", method = {RequestMethod.GET })
	public @ResponseBody void downloadTestReportLIMPS(@PathVariable("qrcode") String qrcode, @PathVariable("checksum") String checksum,
		...
		try {
			...
			InputStream inputStream = service.downloadTestReportLIMPS(ftpClient,qrcode, fileName);
			if (inputStream != null) {
